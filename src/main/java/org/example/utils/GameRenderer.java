...
public class GameRenderer {
    ...
    public void drawSnake(Snake snake, double spacing) {
        ...
        double angle = getAngle(snake, body, head);
    ...
    private static double getAngle(Snake snake, LinkedList<Coordinate2D<Integer>> body, Coordinate2D<Integer> head) {
        double dirX = 0;
        double dirY = 0;
        ...
        return Math.toDegrees(Math.atan2(dirY, dirX));
    }
